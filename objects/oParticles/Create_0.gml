...
var lifetime = 10, size = 2, size_incr = -0.1
var sp = 7
part_type_sprite(p_shoot_burst, sShootBurstS, false, true, false)
...
var lifetime = 40, size = 1, size_incr = 0
var sp = 0
part_type_sprite(p_explosion, sExplosion, true, true, false)
...
var lifetime = 40, size = 1, size_incr = 0
part_type_sprite(p_explosion_big, sExplosion, true, true, false)
...
var lifetime = 15, size = 0.8, size_incr = 0
var sp = 0
part_type_sprite(p_bullet_burst, sShootBurstS, false, false, false)
